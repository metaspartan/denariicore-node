...
var p2p = require('bitcore-p2p-denarius');
var Peer = p2p.Peer;
  ...
  before(function(done) {
    ...
    rimraf(datadir + '/regtest', function(err) {
      ...
      bitcoind = require('../').services.Bitcoin({
        spawn: {
          datadir: datadir,
          exec: path.resolve(__dirname, process.env.HOME, './.bitcore/data/denariusd')
        },
        node: {
      ...
      log.info('Waiting for Denarius Core to initialize...');
