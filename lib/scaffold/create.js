...
var BASE_PACKAGE = {
  ...
  readme: 'README.md',
  dependencies: {
    'denariicore-lib': '^' + bitcore.version,
    'bitcore-node-denarius': version
  }
};
...
function createConfigDirectory(options, configDir, isGlobal, done) {
  mkdirp(configDir, function(err) {
    ...
    try {
      fs.writeFileSync(configDir + '/bitcore-node-denarius.json', configJSON);
      if (!isGlobal) {
...
function create(options, done) {
  ...
  async.series([
    function(next) {
      // Setup the the bitcore-node-denarius directory and configuration
