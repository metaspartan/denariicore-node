...
/**
 * Will return the path and denariicore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'denariicore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'denariicore-node.json'))
  };
}
